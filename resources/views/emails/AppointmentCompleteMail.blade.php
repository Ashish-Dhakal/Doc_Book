    ...
    <div class="container mt-5">
        <div class="card shadow-lg border-light">
            ...
            <div class="card-header bg-primary text-white text-center">
                <h3 class="font-weight-bold">Appointment Details</h3>
            </div>
            ...
            <div class="card-body">
                ...
                <div class="mb-4">
                    ...
                    <p><strong class="font-weight-bold">Full Name:</strong> {{ $appointment->patient->user->f_name }} {{ $appointment->patient->user->l_name }}</p>
                </div>

                <!-- Doctor Info -->
                <div class="mb-4">
                    <h5 class="text-primary font-weight-bold">Doctor Details</h5>
                    <p><strong class="font-weight-bold">Doctor Name:</strong> {{ $appointment->doctor->user->f_name }} {{ $appointment->doctor->user->l_name }}</p>
                </div>
                ...
                <div class="mb-4">
                    ...
                    <p><strong class="font-weight-bold">Appointment Date:</strong> {{ \Carbon\Carbon::parse($appointment->date)->format('F j, Y') }}</p>
