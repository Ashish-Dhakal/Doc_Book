        ...
        <div class="container mx-auto flex justify-between items-center px-6">
            ...
            <div class="space-x-6 hidden md:flex">
                ...
                @php
                    $user = Auth::user();
                    if ($user) {
                        echo '<a href="/dashboard" class="bg-blue-600 text-white px-4 py-2 rounded-full hover:bg-blue-700 transition">Dashboard</a>';
                    } else {
                        echo '<a href="/login" class="bg-blue-600 text-white px-4 py-2 rounded-full hover:bg-blue-700 transition">Login</a>';
                    }
                @endphp
            </div>
