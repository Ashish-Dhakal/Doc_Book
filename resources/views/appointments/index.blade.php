                ...
                <div class="bg-white shadow-lg rounded-lg my-8 p-8">
                    ...
                    <table class="min-w-full table-auto border-collapse bg-gray-100 rounded-lg shadow-md">
                        ...
                        <tbody class="text-gray-800">
                                ...
                                <tr class="border-b hover:bg-gray-50">
                                    ...
                                    <td class="px-6 py-3 ">
                                        <form action="{{ route('appointments.updateStatus', $appointment->id) }}"
                                            ...
                                            {{-- content inside div should display flex abd align items center --}}
                                          <div class="flex ">
                                            <select name="status"
                            ...
                            @empty
                                <tr>
                                    <td colspan="7" class="text-center py-4">No Appointments</td>
                                </tr>
                            @endforelse
                        </tbody>
                    </table>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    @foreach ($appointments as $appointment)
                        <div class="bg-white shadow-lg rounded-lg p-6">
                            ...
                            <div class="mb-2">
                                <span class="font-bold">Patient ID:</span> {{ $appointment->patient->user->f_name }}
                                {{ $appointment->patient->user->l_name }}
                            </div>
                            <div class="mb-2">
                                <span class="font-bold">Doctor ID:</span> {{ $appointment->doctor->user->f_name }}
